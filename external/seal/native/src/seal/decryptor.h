    ...
    */
    ...
    public:
        ...
        */
        ...
        void decrypt_hacked(const Ciphertext &encrypted, std::vector<std::vector<uint64_t>> &result);
    ...
    private:
        ...
        void bfv_decrypt_hacked(const Ciphertext &encrypted, std::vector<std::vector<uint64_t>> &result,
            MemoryPoolHandle pool);
