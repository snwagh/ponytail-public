    ...
    */
    ...
    public:
        ...
        */
        ...
        void multiply_inplace_hacked(Ciphertext &encrypted1, const Ciphertext &encrypted2,
        ...
        */
        ...
        inline void multiply_hacked(const Ciphertext &encrypted1,
            const Ciphertext &encrypted2, Ciphertext &destination,
	    const std::vector<uint64_t> &mods1, const std::vector<uint64_t> &mods2,
            MemoryPoolHandle pool = MemoryManager::GetPool())
        {
            if (&encrypted2 == &destination)
            {
                multiply_inplace_hacked(destination, encrypted1, mods1, mods2, std::move(pool));
            }
            else
            {
                destination = encrypted1;
                multiply_inplace_hacked(destination, encrypted2, mods1, mods2, std::move(pool));
            }
        }
        ...
        */
        ...
        void multiply_monomial(Ciphertext &encrypted,
         size_t mono_exponent,  MemoryPoolHandle pool = MemoryManager::GetPool());

         
        void multiply_plain_inplace_hacked(Ciphertext &encrypted,
        ...
        */
        ...
        /**
         ...
         The hoisting technique in HS18 was applied to perform an expensive precomputation
         that depends only the input ciphertext.

         @param[in] encrypted The ciphertext to apply the Galois automorphism to
         @param[in] galois_elt The Galois elements
         @param[in] galois_keys The Galois keys
         @param[in] pool The MemoryPoolHandle pointing to a valid memory pool
         */
        void apply_galois_many(std::vector<Ciphertext> &encrypted,
    ...
    private:
        ...
        void bfv_multiply_hacked(Ciphertext &encrypted1, const Ciphertext &encrypted2,
